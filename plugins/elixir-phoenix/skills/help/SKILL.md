---
name: phx:help
description: "Interactive command advisor — helps choose the right /phx: command, skill, or agent. TRIGGER when user asks \"which command\", \"what should I use\", \"how do I\", \"help me decide\", \"what tools\", \"where do I start\", or invokes /phx:help. DO NOT trigger for /help (built-in CLI command)."
